...
NIconButton {
    ...
    function getOnThemeColor(type) {
        switch (type) {
            case "Primary": return Color.mOnPrimary
            case "Secondary": return Color.mOnSecondary
            case "Tertiary": return Color.mOnTertiary
            case "Error": return Color.mOnError
